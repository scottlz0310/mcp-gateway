...
### v0.2.0 リリース済み（2026-05-05）

v0.2.0 の実装項目はすべてマージ済み。v0.1.0 E2E ランブックによる受け入れ検証完了後、v0.2.0 として GitHub Release 公開済み。

| 項目 | 状態 |
|------|------|
| **v0.1.0 E2E 動作検証**（[`docs/runbook-e2e-v0.1.0.md`](docs/runbook-e2e-v0.1.0.md)） | ✅ 完了（v0.2.0 リリースゲート通過） |
| **Device Flow per-device ポーリング直列化**（PR #40） | ✅ PR マージ済み |
| **age X25519 シークレット暗号化**（PR #37） | ✅ PR マージ済み |
| **初回起動セットアップウィザード**（PR #38） | ✅ PR マージ済み |
| **v0.2.0 リリース** | ✅ 完了（2026-05-05） |
